...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ISTAT. TEMİZLE butonuna basılınca bütün Spektrum verileri temizlenicek
        Button cleanButton = findViewById(R.id.btnStatTemizle);
        cleanButton.setOnClickListener(view -> {
            edtOfSet.setText("");
            edtBantGenisligiSpektrum.setText("");
            edtPencereUz.setText("");
            spinnerWindowingTip.setSelection(0);
            spinnerFrekCoz.setSelection(0);
            spinnerSelaleZAraligi.setSelection(0);
            spinnerSinyalStat.setSelection(0);
        });
    }
